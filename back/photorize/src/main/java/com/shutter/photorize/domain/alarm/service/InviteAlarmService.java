...
public class InviteAlarmService {
    ...
    public void resendInviteAlarm(InviteAlarmResendRequest inviteAlarmResendRequest) {
        ...
        updateInviteAlarm(inviteAlarm);
        fcmService.sendPublicAlarm(member, inviteAlarm.getSender());
    }
    ...
    private void updateInviteAlarm(InviteAlarm inviteAlarm) {
        if (inviteAlarm.isDeleted()) {
            inviteAlarm.restore();
        } else {
            inviteAlarm.refreshUpdatedAt();
        }
    }
}
